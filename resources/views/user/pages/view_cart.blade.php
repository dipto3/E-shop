            ...
            @foreach ( $carts as  $cart)
             <div class="card rounded-0 mb-3">
               <div class="card-body">
                 ...
                 <div class="h6 fw-light text-muted text-decoration-line-through">&#2547;{{ $cart->base_price }}</div>
                 @else
                 ...
                 <div class="h6 fw-bold text-danger">(70% off)</div>
                  ...
                  <button type="button" class="btn btn-sm btn-light border rounded-0" data-bs-toggle="modal" data-bs-target="#QtyModal">Qty :  {{ $cart->quantity }}</button>
                         </div>
                    </div>
            <div class="d-none d-lg-block vr"></div>
            <div class="d-grid gap-2 align-self-start align-self-lg-center">
               <a href="{{url('/delete_cart/'.$cart->id)}}" onclick=" confirmation(event)" class="btn btn-ecomm"><i class="bi bi-x-lg me-2"></i>Remove</a>
