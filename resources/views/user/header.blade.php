...
<header class="top-header">
    <nav class="navbar navbar-expand-xl w-100 navbar-dark container gap-3">
      <a class="navbar-brand d-none d-xl-inline" href="{{ url('/') }}"><img src="assets/images/logo.webp" class="logo-img" alt=""></a>
                ...
                <div class="row">
                  <div class="col-12 col-xl-4">
                    ...
                    <ul class="list-unstyled">
                      ...
                      <li><a href="{{url('/productbycat/'.$category->name)}}">{{$category->name}}</a>
                      </li>
                      @endforeach
      ...
      <ul class="navbar-nav secondary-menu flex-row">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ url('/account-dashboard') }}"><i class="bi bi-person-circle"></i></a>
        </li>
      </ul>
    </nav>
  </header>
